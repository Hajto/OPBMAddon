...
import com.haito.opbmaddon.client.renderer.tileEntity.UnholyPylonRenderer;
...
public class ClientProxy extends CommonProxy {
    ...
    public void initRenderStuff(){
        ClientRegistry.bindTileEntitySpecialRenderer(TEUnholyPylon.class, new UnholyPylonRenderer());
